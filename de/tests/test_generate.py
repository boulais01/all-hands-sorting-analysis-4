...
def test_generate_lists():
    ...
    assert len(generate.generate_lists(enumerations.ListData.ints, 1, 5)) == 5
    assert len(generate.generate_lists(enumerations.ListData.floats, 1, 5)) == 5
    assert len(generate.generate_lists(enumerations.ListData.strings, 1, 5)) == 5
